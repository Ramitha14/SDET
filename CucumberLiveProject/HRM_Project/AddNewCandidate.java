...
public class AddNewCandidate {
    ...
    public void CandidateInformation() {
    	...
    	driver.findElement(By.id("addCandidate_firstName")).sendKeys("Ramitha");

    	driver.findElement(By.id("addCandidate_lastName")).sendKeys("Mylsamy");

    	driver.findElement(By.id("addCandidate_email")).sendKeys("Sample123@mail.com");
    ...
    public void Verfication() {	
    	...
    	Name.sendKeys("Ramitha Mylsamy");

    	driver.findElement(By.id("btnSrch")).click();    	    	

    	String JobTitle1 = driver.findElement(By.linkText("Ramitha Mylsamy")).getText();

    	Assert.assertEquals(JobTitle1, "Ramitha Mylsamy"); 
