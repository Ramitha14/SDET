...
public class CreateJobVacancy {
    ...
    public void AddVacancies() {
    	...
    	driver.findElement(By.id("addJobVacancy_name")).sendKeys("Test Vacancy");
    ...
    public void VerifyVacancies() {
    	...
    	dropdown2.selectByVisibleText("Test Vacancy");
    	...
    	String JobTitle1 = driver.findElement(By.linkText("Test Vacancy")).getText();

    	Assert.assertEquals(JobTitle1, "Test Vacancy");  	    
